...
use Modules\Emergency\Controllers\EmergencyController;

Route::middleware(ValidateHeaders::class)->group(function () {

    Route::prefix('api/v1/emergency')->group(function () {
        Route::controller(EmergencyController::class)->group(function () {
            ...
            Route::middleware(['auth:sanctum'])->group(function () {
                ...
                Route::prefix('order')->group(function () {
                    ...
                    Route::get('/list-services', 'listServices');
                    Route::post('/update-order-services', 'updateOrderServices');
                });
            });
        });
    });
